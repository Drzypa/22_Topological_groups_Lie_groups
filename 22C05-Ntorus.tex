...
\usepackage{pmmeta}
\pmcanonicalname{Ntorus}
\pmcreated{2013-03-22 13:59:58}
\pmmodified{2013-03-22 13:59:58}
\pmowner{ack}{3732}
\pmmodifier{ack}{3732}
\pmtitle{$n$-torus}
\pmrecord{7}{34820}
...
%% \include{argawarga}
\begin{document}
The \emph{$n$-torus}, denoted $T^n$, is a smooth orientable $n$ dimensional manifold which is the product of $n$ 1-spheres, i.e. $T^n = \underbrace{ S^{1} \times \cdots \times S^{1}}_{n}$.
...
\begin{displaymath}
(z_1,z_2,\ldots,z_n) \cdot (w_1,w_2,\ldots,w_n) = (z_1w_1,z_2w_2,\ldots,z_nw_n)
\end{displaymath}
%%%%%
%%%%%
\end{document}
