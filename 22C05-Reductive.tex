...
\usepackage{pmmeta}
\pmcanonicalname{Reductive}
\pmcreated{2013-03-22 13:23:49}
\pmmodified{2013-03-22 13:23:49}
\pmowner{bwebste}{988}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $G$ be a Lie group or algebraic group.  $G$ is called {\em reductive} over a field $k$ if every representation of $G$ over $k$ is completely reducible
