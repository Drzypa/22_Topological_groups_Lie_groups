...
\usepackage{pmmeta}
\pmcanonicalname{TopologicalSpace}
\pmcreated{2013-03-22 11:49:52}
\pmmodified{2013-03-22 11:49:52}
\pmowner{djao}{24}
\pmmodifier{djao}{24}
\pmtitle{topological space}
\pmrecord{12}{30380}
\pmprivacy{1}
\pmauthor{djao}{24}
\pmtype{Definition}
...
\pmsynonym{topology}{TopologicalSpace}
%\pmkeywords{open set}
%\pmkeywords{closed set}
\pmrelated{Neighborhood}
\pmrelated{MetricSpace}
\pmrelated{ExamplesOfCompactSpaces}
\pmrelated{ExamplesOfLocallyCompactAndNotLocallyCompactSpaces}
\pmrelated{Site}
\pmdefines{open}
\pmdefines{closed}
