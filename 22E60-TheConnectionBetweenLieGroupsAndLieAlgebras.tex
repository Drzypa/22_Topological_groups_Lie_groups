...
\usepackage{pmmeta}
\pmcanonicalname{TheConnectionBetweenLieGroupsAndLieAlgebras}
\pmcreated{2013-03-22 13:20:56}
\pmmodified{2013-03-22 13:20:56}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{the connection between Lie groups and Lie algebras}
\pmrecord{10}{33867}
\pmprivacy{1}
...
\begin{thm}
(Existence) Let $\fr g$ be a finite dimensional Lie algebra over $\R$ or $\C$.  Then there exists a finite dimensional real or complex Lie group $G$ with $\Lie(G)=\fr g$.
\end{thm}
...
Even more important, is the fact that the correspondence $G\mapsto\fr g$ is functorial:  given a homomorphism $\vp:G\to H$ of Lie groups, there is natural
homomorphism defined on Lie algebras $\vp_*:\fr g\to\fr h$, which just the derivative of the map $\vp$ at the identity (since the Lie algebra is canonically identified with the tangent space at the identity).

There are analogous existence and uniqueness theorems for maps:

\begin{thm}(Existence) Let $\psi:\fr g\to\fr h$ be a homomorphism of Lie algebras.  Then if $G$ is the unique connected, simply-connected group with Lie algebra $\fr g$, and $H$ is any Lie group with Lie algebra $\fr h$, there exists a homomorphism of Lie groups $\vp:G\to H$ with $\vp_*=\psi$.
\end{thm}

\begin{thm} (Uniqueness)
Let $G$ be connected Lie group and $H$ an arbitrary Lie group.  Then if two maps $\vp,\vp':G\to H$ induce the same maps on Lie algebras, then they are equal.
\end{thm}

Essentially, what these theorems tell us is the correspondence $\fr g\mapsto G$ from Lie algebras to simply-connected Lie groups is functorial, and right \PMlinkname{adjoint}{AdjointFunctor} to the functor $H\mapsto\Lie(H)$ from Lie groups to Lie algebras.
%%%%%
%%%%%
\end{document}
